  ...
  return (
    <div className="border p-4 lg:p-6 border-white">
      <div className="w-full relative group" style={{ lineHeight: 0 }}>
        ...
        />
        <div
          className={`lg:absolute ${styles[leftOrRight].containerPosition} top-0 bottom-0 ${styles[leftOrRight].textAlign} flex flex-col justify-center items-start sm:gap-y-2 lg:max-w-[70%]`}
        >
          <H3
