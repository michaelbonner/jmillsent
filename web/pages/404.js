...
function NotFound() {
  ...
  return (
    <Layout title={`404: This page could not be found.`} description={''}>
      <div className="grid gap-y-8 container px-4 mx-auto text-white text-center my-12 lg:my-36">
        <svg
          className="fill-white hover:fill-current w-24 mx-auto transition-colors duration-[10ms] group"
        ...
        >
          ...
          <path
            className="group-hover:-translate-y-0.5 transition-transform duration-200 ease-in-out"
