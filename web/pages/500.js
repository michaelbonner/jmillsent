...
function ServerError() {
  ...
  useEffect(() => {
    ...
    return () => {
      clearInterval(skullColorInterval)
    }
  }, [])

  return (
    <Layout title={`500: Server Error`} description={''}>
      <div className="container mx-auto my-12 grid gap-y-8 px-4 text-center text-white lg:my-36">
        <svg
          className="group mx-auto w-24 fill-white transition-colors duration-[10ms] hover:fill-current"
        ...
        >
          ...
          <path
            className="transition-transform duration-200 ease-in-out group-hover:-translate-y-0.5"
            d="m42.3 62.2c0 4.7-.9 9.2-3.8 13.1-1.8 2.6-4.4 4.5-7.4 5.7-1.2.4-2.5.3-3.7-.1-2.7-1-4.8-2.9-5.4-6 0-.2-.1-.4-.2-.7-2.6-4.4-2.4-9-1-13.7.4-1.4 1.2-2.7 2.1-3.8 1.1-1.3 2.1-2.6 3.1-4 .8-1.1 2.1-1.9 3.4-2.2 1.9-.4 3.8-.6 5.6.7.1.1.2.1.4.1 1.6-.2 3.3.1 4.8.8.4.2.7.5.8.8.8 3.1 1.3 6.2 1.3 9.3z"
          />
          <path
            className="transition-transform duration-200 ease-in-out group-hover:-translate-y-0.5"
            d="m62.9 63.3c0-4.1 1.2-8.1 3.6-11.4.2-.3.6-.5.9-.5 2.2-.6 4.4-.3 6.6 0 .2.1.5.1.7 0 1.4-.5 2.9.1 3.6 1.4.9 1.2 1.7 2.4 2.4 3.8 1.4 3 2.5 6.1 3.4 9.3 1.4 5.6-1.2 10.1-5 13.9-1.6 1.6-4 1.8-5.9.6-1.5-.8-2.9-1.9-4.1-3.2-1.6-1.8-2.9-3.9-4.4-5.9-1.3-1.9-1.9-4.1-1.8-6.3 0-.7 0-1.2 0-1.7z"
          />
          <path
            className="transition-transform duration-200 ease-in-out group-hover:translate-y-0.5"
            d="m51.4 88.6c-.3.9-.6 1.7-.8 2.6-.3 2-1.9 2.6-3.4 3.4-.8.4-1.6-.3-1.6-1.3.1-1.2.2-2.3.1-3.5-.7-4.2 1.2-7.7 2.6-11.3.6-1.6 2.2-2.5 3.9-2.4.3 0 .5.1.7.3.7.6 1.4 1.3 2.1 2 2.1 2.1 2.2 4.8 2.5 7.5.1 1 0 1.9 0 2.9.1 1.9-.9 3.1-2.2 4.2-.4.4-1.2.5-1.6.1-1-.6-1.8-1.3-1.7-2.7 0-.5-.1-1-.3-1.5z"
          />
        </svg>
        <H1>
          500
          <br />
          <span className="text-xl lg:text-5xl">Something went wrong</span>
        </H1>
        <div className="prose prose-lg mx-auto">
          <p className="text-gray-100">
            We&apos;re experiencing a server error. Please try again later or
            use the site navigation to find what you are looking for.
          </p>
        </div>
