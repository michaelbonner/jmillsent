      ...
      <div className="px-4 lg:px-8">
        <div className="my-12 max-w-9xl border border-gray-300 p-4 px-4 xl:mx-auto xl:p-8">
          <VideoPlayer
            ...
            videoHeightAspectRatio={portfolioItem.videoHeightAspectRatio || '9'}
            videoWidthAspectRatio={portfolioItem.videoWidthAspectRatio || '16'}
          />
        </div>
      </div>
...
export async function getStaticProps({ params }) {
  ...
  try {
    ...
    return {
      props: { portfolioItem, portfolioItems },
    }
  } catch (error) {
    return {
      props: {},
