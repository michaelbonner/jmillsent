      ...
      {studioPage.tourVideoId && (
        ...
        >
          <div className="inline-block">
            <div
              className="flex gap-4 items-center justify-center px-3 py-2 mt-4 sm:mt-10 uppercase hover:bg-gold transition-colors border-2 border-white text-3xl group"
              target="_blank"
            >
